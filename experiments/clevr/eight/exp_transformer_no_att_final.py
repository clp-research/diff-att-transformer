...
config.model_name = "no_att_8_MODEL_FINAL"
...
config.batch_size = 8  # increase batch size for fixed encoder (more RAM available)
...
config.data_name = 'CLEVR_CHANGE_5_cap_per_img_pair_1_min_word_freq'  # base name shared by data files
...
from models.transformer_no_att_model import Transformer, ImageEncoder
