...
def main(data_split, rel_output_path):
    ...
    # model
    checkpoint_name = "no_att_2_MODEL_FINAL"
    ...
    output_dir = "{}/results/clevr_2/noatt".format(data_folder)
    ...
    context = TestContext(output_file_path, word_map, rev_word_map, beam_size=5, nb_heads=2)
    ...
    dataset = CaptionDataset(data_folder, data_name, "TEST_" + data_split.upper(),
